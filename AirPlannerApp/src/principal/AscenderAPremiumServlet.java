...
/**
 * Servlet implementation class AscenderAPremiumServlet
 */
@WebServlet("/html/ascenderUsuario")
public class AscenderAPremiumServlet extends HttpServlet {
     ...
     */
    public AscenderAPremiumServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuarioDao.ascenderApremium(userName)) {
			...
			out.println("<html lang = \"es\">\r\n"
					...
					+ "\r\n"
					+ "		<div>\r\n"
					+ "			<h4> Se ha suscrito a AirPlanner Premium</h4>\r\n"
					+ "			<p> Se le enviarán los detalles por correo </p>\r\n"
					+ "         <p> Haga click en continuar </p> "
					+ "			<a class=\"btn btn-outline-secondary btn-lg text-white\" href=\"dashboard_premium.html\">Continuar</a>\r\n"
					+ "			\r\n"
					+ "		</div>\r\n"
